...
const clearInput = function (val1, other = false) {
  if (other) {
    val1.value = other.value = '';
    val1.blur();
    other.blur();
  } else {
    val1.value = '';
...
const checkDogs = function (dogsJulia, dogsKate) {
  const dogsJulia_ = dogsJulia.slice(1, -2);
  const dogsBoth = [...dogsJulia_, ...dogsKate];

  dogsBoth.forEach(function (mov, i, arr) {
    console.log(
      `Dog number ${i + 1} is a${
        mov >= 3 ? 'n adult' : ' puppy'
...
console.log('______ FIRST DATASET ______');
checkDogs([3, 5, 2, 12, 7], [4, 1, 15, 8, 3]);

console.log('______ SECOND DATASET ______');
...
console.log(arr.slice(2)); // c - e returns new array
console.log(arr.slice(2, 4)); // c, d

console.log(arr.slice(-2)); // can start from end of array
console.log(arr.slice(-1));
console.log(arr.slice(1, -2)); // b, c

console.log(arr.slice()); // shallow copy of array
console.log([...arr]); // same result as previous line
...
console.log(letters);
console.log([...arr, ...arr2]); // does NOT mutate original array
